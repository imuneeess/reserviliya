...
function makeTrainReservation($firstName, $lastName, $email, $reservationDate, $reservationTime, $reservationType, $selectedTrain, $selectedCity, $paymentType, $conn) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $reservationType = "train"; // Set the reservation type to "train"
    $selectedTrain = $_POST["train"];
    $selectedCity = $_POST["town"];
    $paymentType = $_POST["payment_type"];

    // Check if train is set
    if (isset($_POST["train"])) {
        makeTrainReservation($firstName, $lastName, $email, $reservationDate, $reservationTime, $reservationType, $selectedTrain, $selectedCity, $paymentType, $conn);
    }
}
...
<head>
    ...
    <title>Train Route Reservation System</title>
...
<div class="container">
    <h1>Welcome to the Train Route Reservation System!</h1>
    ...
    <form method="post" action="">
        ...
        <select name="town" id="town" onchange="populateTrains()" required>
        ...
        <label for="train">Select a Train:</label>
        ...
        <input type="text" name="reservation_type" id="reservation_type" value="train" disabled>
    ...
    <div class="options" id="trainOptions">
...
<script>
    function populateTrains() {
        var trains = {
            Casablanca: ['Train 1', 'Train 2', 'Train 3'],
            Rabat: ['Train A', 'Train B', 'Train C'],
            Marrakech: ['Train X', 'Train Y', 'Train Z'],
            Fes: ['Train I', 'Train II', 'Train III'],
            Tangier: ['Train P', 'Train Q', 'Train R']
        };
        ...
        trains[selectedCity].forEach(function (train) {
        ...
        trains[selectedCity].forEach(function (train) {
            ...
            optionDiv.innerHTML = '<img src="https://via.placeholder.com/200?text=' + train + '" alt="' + train + '"><p>' + train + '</p>';
            trainOptions.appendChild(optionDiv);
        });
